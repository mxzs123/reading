...
import type { AudioStore, SegmentStatus, UploadStatus, GenerationTask } from "./types";
import {
...
import { getAudio, stopSyncLoop, startSyncLoop } from "./audioPlayer";
...
export const useAudioStore = create<AudioStore>((set, get) => {
  ...
  const setSegmentUploadState = (segmentId: string, patch: Partial<{ uploadStatus: UploadStatus; uploadError?: string; uploadAttempts?: number }>) => {
    set((state) => ({
  ...
  return {
    ...
    generateSegment: async (id, params) => {
      ...
      return new Promise<void>((resolve) => {
        enqueueGenerationTask({ id, params, settle: resolve });
      });
    },
